...
# params
params = {
  'op': ['op10', 'op20', 'op30', 'op40', 'op50'],
  'session': ['sess2', 'sess5', 'sess10', 'sess15', 'sess20', 'sess25', 'sess30', 'sess40', 'sess50'],
  'txn': ['txns-per-session100', 'txns-per-session200', 'txns-per-session300', 'txns-per-session400', 'txns-per-session500'],
}
