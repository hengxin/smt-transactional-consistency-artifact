...
history_path = os.path.join(root_path, 'history', 'ser', 'scalability-2')
...
memory_limit = 30 * 1024 * 1024 * 1024  # 30 GB
...
output_path = os.path.join(root_path, 'results', 'scalability-100k.json')
